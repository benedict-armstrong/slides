...
- [ ] Add a little about page with how it works and a link to the github repo.
- [ ] As soon as someone uploads a presentation add state to the url so the user can always navigate back to the presentation and a code that they can share with others to join as viewer or controller.
- [ ] Add a field where user can put in code for an existing presentation. When someone visits the should either upload a presentation or enter the code to join an existing presentation as viewer or controller.
- [ ] Add a download button for anyone to download the presentation.
